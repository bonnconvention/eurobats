...
jQuery(document).ready(function($) {
	...
	function rotateBanners(){
    	$('#header-images').cycle({  // rotate banners
    		slideExpr:'img.slide',
			fx:     '' + Drupal.settings.eurobats2.banner_effect + '',
			timeout:  parseInt(Drupal.settings.eurobats2.banner_delay),
			speed:  parseInt(Drupal.settings.eurobats2.banner_speed),
			pause:  parseInt(Drupal.settings.eurobats2.banner_pause),
			before: onBefore ,
