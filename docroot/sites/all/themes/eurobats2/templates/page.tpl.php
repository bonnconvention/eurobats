  ...
  <div id="pageBorder" <?php print $noborder; ?>>
    <?php if ((!$usebanner && $page['advertise']) || ($usebanner && $banner_image)): ?>
      ...
      <div id="header-images" <?php print ($usebanner == 0) ? 'class="unlimited"' : ""; ?>>
        ...
        <?php elseif ($banner_image): // Use eurobats2 banners ?>
    ...
    <div id="contentWrapper">
      ...
      <!--start innercontent-->
        ...
        <!--start main content-->
				<div class="<?php print eurobats2_c_c($page['sidebar_first'], $page['sidebar_second'], $layoutType,$exception); ?>" id="siteContent">
        ...
        <!--end main content-->
          ...
          <div class="<?php print eurobats2_w_c($layoutType); ?>" id="sidebarWrapper">
            <!--start oversidebars-->
        ...
        <?php endif; ?>
          ...
          <!--start first sidebar-->
          <div class="<?php print eurobats2_s_c($page['sidebar_first'],$page['sidebar_second'],$layoutType,1); ?> sidebar" id="sidebar-first">
        ...
        <?php if($page['sidebar_second']): ?>
          ...
          <div class="<?php print eurobats2_s_c($page['sidebar_first'],$page['sidebar_second'],$layoutType,2); ?> sidebar" id="sidebar-second"><!--start second sidebar-->
